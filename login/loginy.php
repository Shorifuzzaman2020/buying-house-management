                ...
                <center>
                    ...
                    <div>
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            $query = $conn->query("SELECT * FROM `ecl_employee` WHERE (`employee_username` = '$inputUsername' && `employee_pass` = '$inputPassword' && `employee_dept`='Yarn') || ('$inputUsername'='md' && '$inputPassword'='md22')") or die(mysqli_error());
