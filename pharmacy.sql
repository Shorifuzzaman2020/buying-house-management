...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2024 at 01:31 PM
...
CREATE TABLE `account_employee` (
  ...
  `emp_username` varchar(40) DEFAULT NULL,
  `emp_pass` varchar(40) DEFAULT NULL,
  `emp_mail` varchar(40) DEFAULT NULL
...
INSERT INTO `account_employee` (`id`, `emp_id`, `emp_username`, `emp_pass`, `emp_mail`) VALUES
(1, 1, 'mahfuz', 'mah22', 'mahfuz@gmail.com');
...
(5, 'dddddddd', 'dddddd', 5, 'select', 3, 'ddddddd'),
...
--
-- Table structure for table `ecl_employee`
--

CREATE TABLE `ecl_employee` (
  `id` tinyint(4) NOT NULL,
  `employee_id` int(11) NOT NULL,
  `employee_username` varchar(40) DEFAULT NULL,
  `employee_pass` varchar(40) DEFAULT NULL,
  `employee_email` varchar(40) DEFAULT NULL,
  `employee_dept` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `ecl_employee`
--

INSERT INTO `ecl_employee` (`id`, `employee_id`, `employee_username`, `employee_pass`, `employee_email`, `employee_dept`) VALUES
(1, 1, 'mahfuz', 'mah22', 'mahfuz@gmail.com', 'Accounts'),
(3, 2, 'soil', 'soil22', 'soil@gmail.com', 'Marchant'),
(4, 3, 'deme', 'deme22', 'deme@gmail.com', 'Commercial'),
(5, 4, 'rakib', 'rakib22', 'rakib@gmail.com', 'Yarn');
...
--
-- Table structure for table `marchant_employee`
--

CREATE TABLE `marchant_employee` (
  `id` tinyint(4) NOT NULL,
  `marchant_employee_id` int(11) NOT NULL,
  `marchant_employee_username` varchar(40) DEFAULT NULL,
  `marchant_employee_pass` varchar(40) DEFAULT NULL,
  `marchant_employee_email` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `marchant_employee`
--

INSERT INTO `marchant_employee` (`id`, `marchant_employee_id`, `marchant_employee_username`, `marchant_employee_pass`, `marchant_employee_email`) VALUES
(1, 1, 'soil', 'soil22', 'soil@gmail.com');
...
INSERT INTO `sales` (`SALE_ID`, `MED_ID`, `C_ID`, `S_DATE`, `S_TIME`, `TOTAL_AMT`, `E_ID`) VALUES
(1, 0, 987101, '2020-04-15', '13:23:03', 180.00, 4567009),
(2, 0, 987106, '2020-04-21', '20:19:31', 585.00, 1),
(3, 0, 987103, '2020-04-15', '11:23:53', 120.00, 4567010),
(4, 0, 987104, '2020-04-14', '18:20:00', 955.00, 4567006),
(5, 0, 987103, '2020-04-21', '15:24:43', 45.00, 1),
(6, 0, 987102, '2020-03-11', '10:24:43', 140.00, 4567001),
(7, 0, 987105, '2020-04-24', '00:25:54', 350.00, 1),
(8, 0, 987104, '2020-04-24', '00:47:47', 35.00, 4567001),
(12, 0, 987103, '2020-04-24', '19:33:16', 60.00, 1),
(13, 0, 987104, '2020-04-24', '21:15:56', 62.50, 4567001),
(15, 0, 987107, '2020-12-04', '18:39:46', 420.00, 1),
(16, 0, 987106, '2020-12-04', '18:52:21', 30.00, 1),
(17, 0, 987103, '2020-12-04', '19:35:56', 57.50, 1),
(18, 0, 987105, '2020-12-04', '19:36:56', 160.00, 4567001),
(20, 0, 987103, '2020-12-04', '22:53:18', 150.00, 4567001);
...
--
-- Indexes for table `ecl_employee`
--
ALTER TABLE `ecl_employee`
  ADD PRIMARY KEY (`employee_id`),
  ADD UNIQUE KEY `id` (`id`),
  ADD UNIQUE KEY `employee_username` (`employee_username`),
  ADD UNIQUE KEY `employee_pass` (`employee_pass`),
...
--
-- Indexes for table `marchant_employee`
--
ALTER TABLE `marchant_employee`
  ADD PRIMARY KEY (`marchant_employee_id`),
  ADD UNIQUE KEY `id` (`id`),
  ADD UNIQUE KEY `marchant_employee_username` (`marchant_employee_username`),
  ADD UNIQUE KEY `marchant_employee_pass` (`marchant_employee_pass`),
  ADD UNIQUE KEY `marchant_employee_email` (`marchant_employee_email`);
...
--
-- AUTO_INCREMENT for table `account_employee`
--
ALTER TABLE `account_employee`
  MODIFY `id` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `ecl_employee`
--
ALTER TABLE `ecl_employee`
  MODIFY `id` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `marchant_employee`
--
ALTER TABLE `marchant_employee`
  MODIFY `id` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
